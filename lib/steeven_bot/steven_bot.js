	...
	var commands = {
	    ...
	    "notifiez_canal": {
	        ...
	        process: function(bot, msg, suffix) {
	            fabrique.construireCanal(msg.guild, msg.channel, suffix);
	            msg.channel.sendMessage(msg.author + "Vous etes bien inscrit à " + suffix);
	            console.log(JSON.stringify(fournisseur.canaux, null, 2));
	            if (!suffix) {
	    ...
	    "meilleures_offres": {
	        ...
	        process: function(bot, msg, suffix) {
	        	fabrique.construireCanal(msg.guild, msg.channel, 'meilleurs_offres');
	            msg.author.sendMessage(msg.author + "Vous etes bien inscrit à " + suffix);
				console.log(JSON.stringify(fournisseur.canaux, null, 2));
	        }
	    },
