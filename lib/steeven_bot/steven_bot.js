...
var commands = {
    ...
    "notifiez_moi": {
		...
		process: function(bot, msg, suffix) {
			var verifInscris = fabrique.construireUtilisateur(msg.author.id, suffix);
			if (verifInscris ==  false) {
				msg.author.sendMessage( msg.author + "Désolé "+ suffix+ " n'existe pas.Vous n'etes pas inscrit" );
			}
			else
