...
var commands = {
    ...
    "notifiez_moi": {
			...
			process: function(bot, msg, suffix) {
					...
					msg.author.sendMessage( msg.author + formateur.creerMessage("abonnementItem", suffix).ecrire() );
					if(!suffix){
    ...
    "notifiez_canal": {
        ...
        process: function(bot, msg, suffix) {
            ...
            msg.channel.sendMessage(msg.author + formateur.creerMessage("abonnementItem", suffix).ecrire() );
            if (!suffix) {
