...
var commands = {
    ...
    "meilleures_offres": {
        description: "Notifier les meilleurs offres sur un canal",
        process: function(bot, msg, suffix) {
        	if(suffix)
        		msg.channel.sendMessage(msg.author + "!meilleures_offres ne prend pas d'argument");
        	else {
        		msg.channel.sendMessage(msg.author + "placeholder");
        	}
        }
    },
    "lister": {
	...
	"meilleurs_profits": {
		...
		process: function(bot, msg, suffix) {
			msg.channel.sendMessage(msg.author + formateur.factory().creerMessage("meilleursProfits", suffix).ecrire());
			if(suffix){
