...
function construireListeChangements(longueur) {
    ...
    changementPrix = changementPrix.slice(0, longueur);
    console.log(longueur+" param");
    console.log(changementPrix.length+" longueur");
    for(var i=0;i<changementPrix.length;i++){
       console.log(changementPrix[i]+"changement");
    }
}
